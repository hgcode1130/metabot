...
2. Enable permissions: `im:message`, `im:message:readonly`, `im:message.group_msg` (unmentioned group messages), `im:resource`, `im:chat:readonly` (for group chat detection), `docx:document:readonly`, `wiki:wiki` (for doc reading & wiki sync)
